...
```javascript
import levy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-levy@v0.1.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Levy, cdf, entropy, logcdf, logpdf, mean, median, mode, pdf, quantile, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-levy@v0.1.0-esm/index.mjs';
```
